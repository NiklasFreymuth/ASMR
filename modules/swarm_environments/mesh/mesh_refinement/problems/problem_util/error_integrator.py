...
from modules.swarm_environments.mesh.mesh_refinement.problems.problem_util.error_integrator_util import get_integration_weights, \
...
from modules.swarm_environments.mesh.mesh_refinement.problems.problem_util.pde_solution import PDESolution
from typing import Dict, List, Union, Callable, Optional


class ErrorIntegrator:
    def __init__(self, scale_integration_by_area: bool, error_metrics: Union[List[str], str],
    ...
    def get_error_estimate(self, coarse_basis: Basis,
                           coarse_solution: np.array) -> Dict[str, np.array]:
        """
