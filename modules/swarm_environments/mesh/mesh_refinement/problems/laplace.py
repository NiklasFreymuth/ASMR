...
from modules.swarm_environments.mesh.mesh_refinement.mesh_refinement_visualization import contour_trace_from_element_values, \
    get_mesh_traces
...
class Laplace(AbstractFiniteElementProblem):
    ...
    def _get_error_estimate_from_indicator(self, basis: Basis, solution: np.array) -> np.ndarray:
        raise NotImplementedError("Error estimate not implemented for Convection equation")
